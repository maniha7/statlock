...
const Privacy = () => {
    return(
        ...
        <div className="flex flex-col flex-1 justify-center font-display" >
            <div className="flex flex-1 border-b-4 border-x-2 border-t-1 border-stone-600 rounded-lg self-center" style={{height:"100%"}}>
                    ...
                    <div className="m-2 p-4">
                        ...
                        <h2 className="text-white text-xl underline mb-5 mt-5 font-bold">9. Contact Us</h2>
                            <p className="text-md text-white space-y-2 mb-5">
                                If you have any questions or concerns, contact us <Link className="underline hover:opacity-80 font-bold" to="/contact">here</Link>.
                            </p>
                    </div>
                </div>
            </div>
